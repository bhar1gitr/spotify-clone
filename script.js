...
masterPlay.addEventListener('click',()=>{
    if(audioElement.paused || audioElement.currentTime <= 0 && masterPlayIcon.className == 'bi bi-play-circle'){
        audioElement.play();
        masterPlayIcon.className = 'bi bi-pause-circle';
    }else{
        audioElement.pause();
        masterPlayIcon.className = 'bi bi-play-circle'
    }
})
